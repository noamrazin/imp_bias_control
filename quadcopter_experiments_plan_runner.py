...
from control.experiment.quadcopter_co_experiment import QuadcopterControllerOptimizationExperiment
...
def main():
    ...
    experiment = QuadcopterControllerOptimizationExperiment()
